...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Missing telemetry     | No egress logging on the affected subnet, so the exfiltration question is Unknown rather than Ruled out.                                          | [Evidence readiness register](evidence-readiness-register.md): downgrade existing `EV-xx` Coverage confidence or create the missing source row. |
