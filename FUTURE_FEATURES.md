...
Topics from the research pass that were put through the bar and did not ship. The reasoning is recorded so the judgment is not repeated, and so a later session can see what would have to change for the verdict to change. Everything else that was assessed is in the shipped list below.
