...
| Notify the cyber insurance carrier of a claim-triggering event               | [Regulatory applicability register](../compliance/regulatory-applicability-register.md)       |
...
| Engage an incident-response vendor from outside the carrier's approved panel | [Vendor tiering](../third-party-risk/vendor-risk-tiering-pattern.md)                          |
...
Engaging an incident-response vendor outside a carrier's approved panel is the same kind of authority: it looks operational until the contract makes it a spend and coverage decision.
