...
- A keep decision that overrides the review's finding is an [exception record](../risk-management/security-exception-record.md) with an expiry and a named approver, not a comment field.
