...
| `CAE-052` | Control evidence acceptance register | The phishing-resistant MFA configuration export. Accepted only as Partial because `EXC-2026-031` excludes the legacy administrator role, so it cannot support a Full control assertion or an unqualified customer answer. |
