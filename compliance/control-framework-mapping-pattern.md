...
- A mapping answers which controls satisfy which framework. It does not answer which frameworks and duties bind you in the first place, which is the [regulatory applicability register](regulatory-applicability-register.md). Mapping to a framework nobody has established you are subject to is a common and expensive way to spend a year.
